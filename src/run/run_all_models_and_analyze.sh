#!/bin/bash
# src/run/run_all_models_and_analyze.sh
...
ANALYSIS_SCRIPT="../pipeline/python/05_model_analysis.py"
ENV_ESMC="../../env_esmc"
ENV_ESMIF="../../env_esmif"
LOG_DIR="../../logs"
MODEL_DIR="../../models"
...
run_feature_importance () {
    ...
    run_cmd "Feature importance [$mode_label] $feat" \
        bash -c "cd ../.. && python src/pipeline/python/06_feature_importance.py --features '$feat' --models lr rf --top 30 --top_compare 30 --top_big 70 --out_root 'results/figures/models/feature_importance_${mode_label}'"
}
