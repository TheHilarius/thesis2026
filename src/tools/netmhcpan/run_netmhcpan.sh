...
if [ "$#" -ne 3 ] && [ "$#" -ne 4 ]; then
    ...
    echo "Example: bash src/tools/netmhcpan/run_netmhcpan.sh data/raw/fasta/combined_batches data/processed/netmhcpan my_run"
    echo "Example: bash src/tools/netmhcpan/run_netmhcpan.sh data/raw/fasta/combined_batches data/processed/netmhcpan my_run BA"
    exit 1
fi
